...
exports.jwtBearerToken = exports.userApprovedServiceToken = exports.serviceToken = void 0;
 ...
 */
function jwtBearerToken(userJwt, service, options) {
    return __awaiter(this, void 0, void 0, function () {
        var xsuaa, resolvedService, serviceCreds, opts;
        return __generator(this, function (_a) {
            xsuaa = multiTenantXsuaaCredentials(userJwt);
            resolvedService = environment_accessor_1.resolveService(service);
            serviceCreds = environment_accessor_1.extractClientCredentials(resolvedService.credentials);
            opts = __assign({ enableCircuitBreaker: true }, options);
            return [2 /*return*/, xsuaa_service_1.jwtBearerTokenGrant(xsuaa, serviceCreds, userJwt, opts)
                    .then(function (response) { return response.access_token; })
                    .catch(function (error) {
                    throw new util_1.ErrorWithCause("Fetching a JWT Bearer Token for service \"" + resolvedService.label + "\" failed!", error);
                })];
        });
    });
}
