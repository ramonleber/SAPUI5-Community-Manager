...
function buildCsrfFetchHeaders(headers) {
    var _a;
    var fetchHeader = !util_1.pickValueIgnoreCase(headers, 'x-csrf-token') && {
        'x-csrf-token': 'Fetch'
    };
    var contentLengthHeaderKey = util_1.first(Object.keys(util_1.pickIgnoreCase(headers, 'content-length'))) ||
        'content-length';
...
function makeCsrfRequest(destination, requestConfig) {
    ...
    return http_client_1.executeHttpRequest(destination, requestConfigWithTrailingSlash)
        ...
        return http_client_1.executeHttpRequest(destination, requestConfigWithOutTrailingSlash)
            .then(function (response) { return response.headers; })
