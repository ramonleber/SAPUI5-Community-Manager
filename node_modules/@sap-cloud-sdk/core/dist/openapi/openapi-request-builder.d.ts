...
import { HttpResponse, Method } from '../http-client';
/**
...
export declare class OpenApiRequestBuilder<ResponseT = any> {
     ...
     */
    executeRaw(destination: Destination | DestinationNameAndJwt): Promise<HttpResponse>;
    /**
     * Execute request and get the response data. Use this to conveniently access the data of a service without technical information about the response.
     * @param destination Destination to execute the request against.
     * @returns A promise resolving to the requested return type.
     */
    execute(destination: Destination | DestinationNameAndJwt): Promise<ResponseT>;
    private getPath;
}
