...
function findDestination(destinations, destinationName) {
    ...
    if (instanceDest && subAccountDest) {
        logger.warn("A destination with name " + destinationName + " has been found for the destination serivce instance and subaccount. The instance destination will be used.");
    }
