...
function any() {
    ...
    return new odata_common_1.FilterLambdaExpression(odata_common_1.and(odata_common_1.toFilterableList(filters)), 'any');
}
exports.any = any;
...
function all() {
    ...
    return new odata_common_1.FilterLambdaExpression(odata_common_1.and(odata_common_1.toFilterableList(filters)), 'all');
}
exports.all = all;
