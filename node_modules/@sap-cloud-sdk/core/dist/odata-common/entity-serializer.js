...
function entitySerializer(tsToEdm) {
     ...
     * @returns JSON.
     */
    function serializeEntity(entity, entityConstructor, diff) {
        if (diff === void 0) { diff = false; }
        return __assign(__assign({}, serializeEntityNonCustomFields(entity, entityConstructor, diff)), (diff ? entity.getUpdatedCustomFields() : entity.getCustomFields()));
    }
    function serializeField(field, fieldValue) {
        ...
        if (field instanceof odata_common_1.Link) {
            return fieldValue.map(function (linkedEntity) {
                return serializeEntity(linkedEntity, field._linkedEntity);
            });
        }
     ...
     */
    function serializeEntityNonCustomFields(entity, entityConstructor, diff) {
        if (diff === void 0) { diff = false; }
        return getFieldNames(entity, diff).reduce(function (serialized, key) {
            var _a;
    ...
    function getFieldNames(entity, diff) {
        if (diff === void 0) { diff = false; }
        return entity
            ? diff
