 ...
 */
 interface Request extends EventMessage {
	...
	query : Query
	reply (results) : void
	notify (code?:string|number, msg:string, target:string, args?:{}) : Error
	info (code?:string|number, msg:string, target:string, args?:{}) : Error
	warn (code?:string|number, msg:string, target:string, args?:{}) : Error
	error (code?:string|number, msg:string, target:string, args?:{}) : Error
	rejest (code?:string|number, msg:string, target:string, args?:{}) : Error
}
