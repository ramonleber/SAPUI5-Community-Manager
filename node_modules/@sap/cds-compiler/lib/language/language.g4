...
@after{ /* #ATN 1 */ this.attachLocation($art); }
  :
    ...
    |
      selectItemInline
      ( AS n1=ident['Item'] { $alias=$n1.id }
      | n2=ident['Item'] { $alias=$n2.id;; this.fragileAlias( $alias, true ); }
      )
      {
...
selectItemInline locals[ o = {} ]
  :
    cb='{' { this.notSupportedYet( 'Inline select items are not supported yet', $cb ); }
