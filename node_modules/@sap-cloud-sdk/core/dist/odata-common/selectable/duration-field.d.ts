 ...
 */
export declare class DurtionFieldBase<EntityT extends Entity> extends EdmTypeField<EntityT, moment.Duration> {
    /**
 ...
 * @typeparam EntityT - Type of the entity the field belongs to
 */
export declare class DurationField<EntityT extends Entity> extends DurtionFieldBase<EntityT> {
