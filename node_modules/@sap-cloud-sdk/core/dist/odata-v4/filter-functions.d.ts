 ...
 * @returns The newly created filter function
 */
export declare function fractionalSeconds<EntityT extends Entity>(date: moment.Moment | Field<EntityT>): NumberFilterFunction<EntityT>;
/**
 ...
 * @returns The newly created filter function
 */
export declare function totalOffsetMinutes<EntityT extends Entity>(date: moment.Moment | Field<EntityT>): NumberFilterFunction<EntityT>;
/**
