...
function contains(substr, str) {
    return filter_function_1.filterFunction('contains', 'boolean', substr, str);
}
...
function matchesPattern(str, regex) {
    return filter_function_1.filterFunction('matchesPattern', 'boolean', str, regex);
}
...
function fractionalSeconds(date) {
    return filter_function_1.filterFunction('fractionalseconds', 'decimal', date);
}
...
function totalOffsetMinutes(date) {
    return filter_function_1.filterFunction('totaloffsetminutes', 'decimal', date);
}
...
function maxDateTime() {
    return filter_function_1.filterFunction('maxdatetime', 'decimal');
}
...
function minDateTime() {
    return filter_function_1.filterFunction('mindatetime', 'decimal');
}
 ...
 */
function now() {
    return filter_function_1.filterFunction('now', 'decimal');
}
exports.now = now;
...
function hasSubset(subset, set) {
    return filter_function_1.filterFunction('hassubset', 'boolean', subset, set);
}
...
function hasSubsequence(subsequence, sequence) {
    return filter_function_1.filterFunction('hassubsequence', 'boolean', subsequence, sequence);
}
 ...
 */
exports.filterFunctions = __assign(__assign({}, filter_functions_1.filterFunctions), { contains: contains,
