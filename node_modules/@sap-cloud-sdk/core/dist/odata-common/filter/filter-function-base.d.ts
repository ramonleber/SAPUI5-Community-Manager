 ...
 */
export declare type FilterFunctionParameterType<EntityT extends Entity> = FilterFunctionPrimitiveParameterType | Field<EntityT> | FilterFunction<EntityT, FieldType | FieldType[]> | FilterFunctionPrimitiveParameterType[];
