 ...
 */
exports.kibana = combine(errors({ stack: true }), timestamp(), winston_1.format(kibanaTransformer)(), json());
function kibanaTransformer(info) {
    return __assign(__assign({}, info), { msg: local_1.getMessageOrStack(info), written_ts: new Date(info.timestamp).getTime(), written_at: info.timestamp });
}
