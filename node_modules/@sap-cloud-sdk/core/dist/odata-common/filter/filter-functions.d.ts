 ...
 */
export declare function endsWith<EntityT extends Entity>(str: string | Field<EntityT> | StringFilterFunction<EntityT>, suffix: string | Field<EntityT> | StringFilterFunction<EntityT>): BooleanFilterFunction<EntityT>;
/**
 ...
 * @returns The newly created filter function
 */
export declare function startsWith<EntityT extends Entity>(str: string | Field<EntityT> | StringFilterFunction<EntityT>, prefix: string | Field<EntityT> | StringFilterFunction<EntityT>): BooleanFilterFunction<EntityT>;
/**
 ...
 * @returns The newly created filter function
 */
export declare function length<EntityT extends Entity>(str: string | Field<EntityT> | StringFilterFunction<EntityT>): NumberFilterFunction<EntityT>;
/**
 ...
 * @returns The newly created filter function
 */
export declare function indexOf<EntityT extends Entity>(str: string | Field<EntityT> | StringFilterFunction<EntityT>, substr: string | Field<EntityT> | StringFilterFunction<EntityT>): NumberFilterFunction<EntityT>;
/**
 ...
 * @returns The newly created filter function
 */
export declare function substring<EntityT extends Entity>(str: string | Field<EntityT> | StringFilterFunction<EntityT>, pos: number | Field<EntityT> | NumberFilterFunction<EntityT>, len?: number | Field<EntityT> | NumberFilterFunction<EntityT>): StringFilterFunction<EntityT>;
/**
 ...
 * @returns The newly created filter function
 */
export declare function toLower<EntityT extends Entity>(str: string | Field<EntityT> | StringFilterFunction<EntityT>): StringFilterFunction<EntityT>;
/**
 * Build a filter function to transform a string to upper case. Evaluates to string.
 * @param str - The string to transform. This can either be a string, a reference to a field or another filter function.
 * @returns The newly created filter function
 */
export declare function toUpper<EntityT extends Entity>(str: string | Field<EntityT> | StringFilterFunction<EntityT>): StringFilterFunction<EntityT>;
/**
 ...
 * @returns The newly created filter function
 */
export declare function trim<EntityT extends Entity>(str: string | Field<EntityT> | StringFilterFunction<EntityT>): StringFilterFunction<EntityT>;
/**
 ...
 * @returns The newly created filter function
 */
export declare function concat<EntityT extends Entity>(str1: string | Field<EntityT> | StringFilterFunction<EntityT>, str2: string | Field<EntityT> | StringFilterFunction<EntityT>): StringFilterFunction<EntityT>;
/**
 ...
 * @returns The newly created filter function
 */
export declare function round<EntityT extends Entity>(num: number | Field<EntityT> | NumberFilterFunction<EntityT>, returnType?: 'double' | 'decimal'): NumberFilterFunction<EntityT>;
/**
 ...
 * @returns The newly created filter function
 */
export declare function floor<EntityT extends Entity>(num: number | Field<EntityT> | NumberFilterFunction<EntityT>, returnType?: 'double' | 'decimal'): NumberFilterFunction<EntityT>;
/**
 ...
 * @returns The newly created filter function
 */
export declare function ceiling<EntityT extends Entity>(num: number | Field<EntityT> | NumberFilterFunction<EntityT>, returnType?: 'double' | 'decimal'): NumberFilterFunction<EntityT>;
/**
 ...
 * @returns The newly created filter function
 */
export declare function day<EntityT extends Entity>(date: moment.Moment | Field<EntityT>): NumberFilterFunction<EntityT>;
/**
 ...
 * @returns The newly created filter function
 */
export declare function hour<EntityT extends Entity>(date: moment.Moment | Field<EntityT>): NumberFilterFunction<EntityT>;
/**
 ...
 * @returns The newly created filter function
 */
export declare function minute<EntityT extends Entity>(date: moment.Moment | Field<EntityT>): NumberFilterFunction<EntityT>;
/**
 ...
 * @returns The newly created filter function
 */
export declare function month<EntityT extends Entity>(date: moment.Moment | Field<EntityT>): NumberFilterFunction<EntityT>;
/**
 ...
 * @returns The newly created filter function
 */
export declare function second<EntityT extends Entity>(date: moment.Moment | Field<EntityT>): NumberFilterFunction<EntityT>;
/**
 ...
 * @returns The newly created filter function
 */
export declare function year<EntityT extends Entity>(date: moment.Moment | Field<EntityT>): NumberFilterFunction<EntityT>;
/**
 ...
 * @returns The newly created filter function
 */
export declare function isOf<EntityT extends Entity>(expression: Field<EntityT>, type: string): BooleanFilterFunction<EntityT>;
/**
